...
def runBGP(routers):
    ...
    routers['r1'].cmd('iptables -t nat -A POSTROUTING -s 192.168.1.64/26 -d 140.114.0.2/24 -o r1-eth0 -j SNAT --to-source 140.113.0.40')
    routers['r1'].cmd('iptables -t nat -A POSTROUTING -s 192.168.1.0/26 -d 140.114.0.2/24 -o r1-eth0 -j SNAT --to-source 140.113.0.30')
